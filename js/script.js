window.addEventListener('DOMContentLoaded', ()=>{
    ...
    next.addEventListener('click' , () =>{
        if(offeset == +wightblock.slice(0, wightblock.length - 2) * (slides.length - 1) ){
            offeset = 0;
        }

        else{
            offeset += +wightblock.slice(0, wightblock.length - 2);
        }
    ...
    prev.addEventListener('click' , () =>{
        if(offeset == 0){
            offeset += +wightblock.slice(0, wightblock.length - 2) * (slides.length - 1) 
        }
